...
$router->get("/our-menus", function () { View::render("our-menus", ["title" => "Our Menus - Cafe Javas"], "public"); });
...
$router->get("/system/templates", [SystemController::class, "templates"]);
$router->post("/system/templates", [SystemController::class, "storeTemplate"]);
$router->post("/system/templates/{id}/delete", [SystemController::class, "deleteTemplate"]);
