...
<head>
    ...
    <link href="/assets/css/app.css?v=20260728-grand-menu-columns" rel="stylesheet">
</head>
<body>
...
<div id="wrapper">
    ...
    <footer class="footer_bar">
        ...
        <div class="footer_bar_wrapper">
            <div id="copyright">&copy; 2026 Cafe Javas. Making dining experiences better, one feedback at a time.</div>
