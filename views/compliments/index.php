<section class="panel mb-4">
    <form class="row g-2">
        <div class="col-md-3"><input name="search" value="<?= Security::e($filters['search'] ?? '') ?>" class="form-control" placeholder="Search compliments"></div>
        ...
        <div class="col-md-1"><button class="btn btn-success"><i class="bi bi-search"></i></button></div>
    </form>
</section>

<section class="panel">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="h5 mb-0"><i class="bi bi-hand-thumbs-up text-success"></i> Compliments</h2>
        <span class="badge bg-success"><?= (int) $data['total'] ?> total</span>
    </div>
